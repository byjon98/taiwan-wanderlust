            ...
            <div className="bg-red-50 border border-red-200 rounded-2xl p-4 shadow-sm relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col gap-3">
                ...
                <div className="mt-2 pt-3 border-t border-red-200/50">
                  ...
                  <button onClick={() => window.open(import.meta.env.BASE_URL + 'policy.pdf', '_blank')} className="mt-3 w-full bg-white border-2 border-red-100 text-red-600 font-bold py-2.5 rounded-xl text-sm flex items-center justify-center gap-2 hover:bg-red-50 transition-colors">
